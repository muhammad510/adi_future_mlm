				...
				<div class="adi_future_flipbox mb-30">
					...
					<div class="adi_future_flipbox_back">
						<div class="adi_future_flipbox_inner">
							...
							<div class="flipbox_desc">
								<p>The MLM industry is dynamic, and we believe in continuous learning. Regular training sessions, and conferences keep our members updated on industry trends. </p>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="adi_future_flipbox mb-30">
					...
					<div class="adi_future_flipbox_back">
						<div class="adi_future_flipbox_inner">
							...
							<div class="flipbox_desc">
								<p>We foster a sense of community among our members through events, forums, and recognition programs.</p>
							</div>
						</div>
					</div>
				</div>

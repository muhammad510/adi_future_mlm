...
<?php if (config_item('disable_registration') !== "Yes") { ?>
    <div class="container" style="background-color: rgb(177,177,177,0.3);">
        ...
        <?php echo form_open() ?>
        <h1 align="" style=" padding-top:20px;">Member Registration</h1>
        ...
        <div class="row" id="form" style="border: 2px  black dashed; padding:5px 5px; margin: 10px auto; background-color:yellow; ">

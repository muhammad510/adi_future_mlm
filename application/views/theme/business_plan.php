				...
				<div class="col-lg-12">
					<div class="breatcome_title">
						...
						<div class="breatcome_content">
							<ul>
								<li><a href="<?php echo base_url();?>">Home</a> <i class="fa fa-angle-right"></i> <a href="javaScript:void(0);"> Pages</a> <i class="fa fa-angle-right"></i> <span>Business Plan</span></li>
							</ul>
						</div>
					</div>
				</div>

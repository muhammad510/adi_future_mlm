	...
	<!--==================================================-->
	<!----- Start adi_future Footer Middle Area ----->
	<!--==================================================-->
				...
				<div class="col-lg-3 col-md-6 col-sm-12">
					<div class="widget widgets-company-info">
						...
						<div class="company-info-desc">
							<p style="text-align:justify;font-size:13px;">Welcome to ADI Future, a pioneering force in the world of modern direct selling. Founded on the principles of innovation, integrity, and empowerment, ADI Future is more than just a company—it's a community dedicated to fostering entrepreneurial spirit and driving positive change.
							</p>
						</div>
						<div class="follow-company-info pt-3" style="margin-top:-22px;">
				...
				<div class="col-lg-2 col-md-6 col-sm-12 mvs" style="padding-left:66px;">
					<div id="em-recent-post-widget">
						<div class="single-widget-item">
							...
							<div class="menu-quick-link-container ml-4">
							<ul id="menu-quick-link" class="menu" style="margin-top:30px;">
								<li><a href="<?php echo base_url()?>"> Home</a></li>
								<li><a href="<?php echo base_url()?>site/about">About</a></li>
								<li><a href="<?php echo base_url()?>">Business</a></li>
								<li><a href="<?php echo base_url()?>site/agent">Event</a></li>
			...
			<div class="row footer-bottom mt-70 pt-3 pb-1" style="margin-top:-16px;">
				<div class="col-lg-12 col-md-12">
					<div class="footer-bottom-content">
						...
						<p style="text-align:center;font-size:13px;">© 2023, ADI FUTURE. All rights reserved || Designed and Developed By <a href="https://camwel.com/" target="_blank"><img src="https://camwel.com/assets/images/Website%20Logo.png" style="max-width:50px;" alt="camwel"></a></p>
						</div>
					</div>
				</div>
	...
	<!--==================================================-->
	<!----- End adi_future Footer Middle Area ----->
	<!--==================================================-->
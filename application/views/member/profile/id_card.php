...
<div style="margin: 2% 20%; display: inline-flex">
    ...
    <div class="front">
        ...
        <div class="emp_info" style="text-align: center">
            ...
            <p style="font-size: 10px;">Member</p>
        </div>
    ...
    <div class="back">
        ...
        <div>
        <h4 style="text-align: center; margin-top: 78px"><?php echo config_item('company_name');?></h4>
        </div>
...
<a href="javascript:void(0);" class="btn btn-danger"  id="print">Print</a>

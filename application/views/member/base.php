...
<body>
    ...
    <div id="ui" class="ui">
        ...
        <!--header start-->
        <header id="header" class="ui-header py-3" style="height: 50px !important; background-color:#b30c0c; ">
            ...
            <div class="navbar-collapse nav-responsive-disabled" style="height: 50px !important; background-color:#b30c0c;">
                ...
                <ul class="nav navbar-nav navbar-right hidden-xs">
                    ...
                    <li class="dropdown dropdown-usermenu">
                        <a href="#" class=" dropdown-toggle" data-toggle="dropdown" aria-expanded="true" style="height: 50px !important;">
                            <span class="hidden-sm hidden-xs" style="font-weight: bold">
                                <!-- <?php echo $this->session->name ?> -->
                                <?php


                                $memb = $this->db->select('my_img')->where('id', $this->session->user_id)->get('member')->row();

                                ?>

                                <img src="<?php echo ($memb->my_img) ? base_url() . $memb->my_img : base_url() . 'uploads/default.jpg' ?>" alt="" style="max-width: 20px; border-radius: 30%; ">
        ...
        <!--#####################sidebar start########################################-->
        <aside id="aside" class="ui-aside" style="padding: 10px 5px 10px 5px;">
            <p class="text-center ">
                <a href="<?php echo base_url() ?>member/update_profile_picture" title="click to Update Profile Picture">
                    <img src="<?php echo ($memb->my_img) ? base_url() . $memb->my_img : base_url() . 'uploads/default.jpg' ?>" alt="" style="max-width: 20%; border-radius: 30%;">
                </a>
            </p>
            <ul class="nav" ui-nav>
                <li class="active">
                    <a href="<?php echo base_url('member') ?>">Hi, <?php echo $this->session->name ?><br />(
                        My ID
                        : <?php echo $this->session->prefix . $this->session->user_id ?>)
                    </a>
                </li>
                                    ...
                                    <div class="panel">
                                        <div class="panel-body" style="height: 430px">
                                            ...
                                            ?>
                                                ...
                                                <div class="news" style="border:1px solid gray;padding:10px 5px; ">
                                                    <p class="text-center  bg bg-danger text-danger" style="padding: 10px 0px; font-weight:600">News!</p>

                                                    <marquee behavior="0" direction="up">
                                                        <p style="height:100px"><?php echo ($news->description) ? $news->description : "Welcome to " . config_item('company_name'); ?></p>
